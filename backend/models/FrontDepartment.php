...
/**
 * This is the model class for table "front_department".
 *
 * @property string $id
 ...
 */
class FrontDepartment extends \backend\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            [['introduce'], 'required'],
            [['introduce'], 'string'],
            [['create_time', 'createby', 'update_time', 'updateby', 'order'], 'integer'],
            [['name'], 'string', 'max' => 100],
